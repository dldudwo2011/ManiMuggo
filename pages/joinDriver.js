...
export default function joinDriver(params) {
    return(<div>
    ...
    <div class="gap-8 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 xl:grid xl:grid-cols-12">
        <div class="col-span-8">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-green-400 md:text-5xl lg:text-6xl dark:text-white">Join the ManiMuggo Delivery Team</h1>
            <p class="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Become a part of the ManiMuggo family and help us deliver joy to our customers! As a ManiMuggo driver, you'll enjoy flexible working hours, competitive pay, and the opportunity to meet new people every day. Sign up now and start your journey with us!</p>
            <div class="gap-16 items-center sm:flex">
                <div class="mb-8 text-gray-500 sm:mb-0 dark:text-gray-400">
                    ...
                    <h2 class="mb-3 text-xl font-semibold text-green-400 dark:text-white">Competitive Salary</h2>
                    <p class="mb-4 font-light">Average amount ManiMuggo driver earns is $20000K a year</p>
                ...
                <div class="text-gray-500 dark:text-gray-400">
                    ...
                    <h2 class="mb-3 text-xl font-semibold text-green-400 dark:text-white">Simple steps to register</h2>
                    <p class="mb-4 font-light">Process includes verification such as license and work permit and additional background check</p>
                    <a href="/driver" class="text-gray-900 bg-white border border-green-800 focus:outline-none hover:bg-green-800 hover:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 inline-flex items-center">
...
<section class="bg-green-800 dark:bg-gray-900">
  <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 xl:gap-16 sm:py-16 lg:px-6 ">
      ...
      <div class="text-white dark:text-gray-400 sm:text-lg">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Steps to become a driver</h2>
          <p class="mb-8 font-light lg:text-xl">There are only 4 steps you need to become a driver!</p>
          <div class="py-8 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
              <div class="flex">
                  ...
                  <div>
                      <h3 class="mb-2 text-xl font-bold text-white dark:text-white">1. Provide your information</h3>
                      <p class="mb-2 font-light text-white dark:text-gray-400">Host code that you don't want to share with the world in private GitHub repos only accessible to you and people you share them with.</p>
                  </div>
              </div>
              <div class="flex pt-8">
                  ...
                  <div>
                      <h3 class="mb-2 text-xl font-bold text-white dark:text-white">2. License verification</h3>
                      <p class="mb-2 font-light text-white dark:text-gray-400">See the packages your project depends on, the repositories that depend on them, and any vulnerabilities detected.</p>
                  </div>
              </div>
              <div class="flex pt-8">
                  ...
                  <div>
                      <h3 class="mb-2 text-xl font-bold text-white dark:text-white">3. Work Permit Verification</h3>
                      <p class="mb-2 font-light text-white dark:text-gray-400">Find vulnerabilities in custom code using static analysis. Prevent new vulnerabilities from being introduced by scanning every pull request.</p>
                  </div>
              </div>
              <div class="flex pt-8">
                  <div class="flex justify-center items-center mr-4 w-8 h-8 bg-teal-100 rounded-full dark:bg-teal-900 shrink-0">
                  ...
                  <div>
                      <h3 class="mb-2 text-xl font-bold text-white dark:text-white">4. Background Check</h3>
                      <p class="mb-2 font-light text-white dark:text-gray-400">Find vulnerabilities in custom code using static analysis. Prevent new vulnerabilities from being introduced by scanning every pull request.</p>
                  </div>
              </div>
          </div>
          <p class="text-sm">We will verify these documents and get back to you in 3-5 business days! Please give us time to review!</p>
      </div>
  </div>
</section>
<section class="bg-green-800 dark:bg-gray-900">
  <div class="items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid xl:grid-cols-3 lg:gap-8 xl:gap-24 sm:py-16 lg:px-6">
      <div class="mb-8 lg:mb-0">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">What you need to become a driver</h2>
          <p class="mb-4 text-white sm:text-xl dark:text-gray-400">To ensure customer's satisfication drivers must follow these rules</p>
      </div>
      <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Age</h3>
              <p class="text-white dark:text-gray-400">You must be at least 18 years old</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Valid Vehicle</h3>
              <p class="text-white dark:text-gray-400">A valid vehicle that is registered such as car or motorcycle. Or you can use your personal vehicle such as bicycle or scooter </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Bank Account Number</h3>
              <p class="text-white dark:text-gray-400">Provide a valid bank account information to get your pay</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">ID and background verification</h3>
              <p class="text-white dark:text-gray-400">To ensure we have safe environment for customers you must have no criminal records. You must also be eligible to work in your country</p>
          </div>
      </div>
  </div>
</section>
