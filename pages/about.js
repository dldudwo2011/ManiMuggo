...
export default function about(params){
  ...
  <div class="max-w-screen-xl py-8 lg:py-16 px-4 mx-auto lg:px-6">
      <h2 class="mb-4 text-3xl tracking-tight font-extrabold tracking-tight text-gray-900 sm:text-4xl dark:text-white">About our ManiMuggo™</h2>
      <p class="max-w-2xl font-light text-gray-500 sm:text-xl dark:text-gray-400">Stay up to date with new restaurants and exclusive discounts feel free to sign up with your email.</p>
