  ...
  return (
    <div className="flex flex-col min-h-screen text-gray-900">
            <div className="flex flex-col lg:flex-row flex-1">
                <section className="bg-white bg-blend-multiply w-full lg:w-1/2">
        <div className="relative py-8 px-4 mx-auto max-w-screen-xl text-green-400 lg:py-16 z-1">
          <div className="mb-6 max-w-screen-lg lg:mb-0 ">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-center leading-none md:text-5xl lg:text-5xl">{t('Delicious and fresh food delivered to your doorstep')}</h1>
            <p className="mb-6 font-light text-green-800 text-center lg:mb-8 md:text-lg lg:text-xl">Welcome to ManiMuggo, the future of food delivery. Our platform offers real-time order tracking, ensuring your meals arrive fresh and fast. Whether you're a driver seeking flexible work, a restaurant wanting more customers, or someone craving delicious food, ManiMuggo connects you effortlessly. Join us today and experience<br></br>a new way of food delivery!</p>
            <a href="/restaurants" className="flex justify-center space-x-2 ml-64 items-center w-64 py-3 px-8 font-medium text-center text-green-400 rounded-lg bg-primary-700 hover:bg-primary-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-900 dark:bg-primary-600 dark:hover:bg-green-800 dark:focus:ring-green-800">
              Order Now
            ...
            <a href="#" className="flex justify-center space-x-2 ml-64 items-center w-64 py-3 px-8 font-medium text-center text-green-400 rounded-lg bg-primary-700 hover:bg-primary-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-900 dark:bg-primary-600 dark:hover:bg-green-800 dark:focus:ring-green-800">
              Download App
              <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
            </a>
          </div>           
      ...
      <section className="bg-green-700 text-white">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">The most trusted food delivery platform</h2>
          <p className="text-white sm:text-xl dark:text-gray-400">Here are a few reasons why you should choose ManiMuggo</p>
          <div className="mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p className="mb-4 text-white dark:text-gray-400">You only need a few steps in ordering food</p>
            </div>
            <div>
              ...
              <p className="mb-4 text-white dark:text-gray-400">Delivery that is always on time even faster</p>
            </div>
            <div>
              ...
              <p className="mb-4 text-white dark:text-gray-400">Not only fast for us quality is also number one</p>
            </div>
          </div>
        </div>
      </section>
      <section className="bg-green-700 ">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="text-center text-gray-900">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white-900 lg:text-5xl dark:text-white">Become part of ManiMuggo!</h2>
            <a href="#" className="inline-flex items-center text-lg font-medium text-white hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
          ...
          <div className="justify-evenly flex">
            <div className="grid gap-6 mt-12 lg:mt-14 lg:gap-12 md:grid-cols-2">
              <div className="flex mb-2 md:flex-col md:mb-0">
                ...
                <div>
                  <h3 className="text-xl font-bold md:mt-4 mb-2.5 text-white dark:text-white">Become a driver</h3>
                  <p className="text-white dark:text-gray-400">Join ManiMuggo as a driver and enjoy flexible hours, rewarding earnings, real-time order tracking, easy navigation, and top-notch support, all while making a positive impact by delivering delicious meals to happy customers.</p>
                </div>
                <a href="/joinDriver" className="py-3 inline-flex items-center text-lg font-medium text-white hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
                  Register Now
                  <svg className="ml-1 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                </a>
              </div>
              <div className="flex mb-2 md:flex-col md:mb-0">
                ...
                <div>
                  <h3 className="text-xl font-bold md:mt-4 mb-2.5 text-white dark:text-white">Register your restaurant</h3>
                  <p className="text-white dark:text-gray-400">Register your restaurant with ManiMuggo to expand your customer base, increase your sales, and enjoy seamless integration with our real-time order processing and tracking system, ensuring your delicious meals reach satisfied customers quickly and efficiently.</p>
                </div>
                <a href="/registerRestaurant" className="py-3 inline-flex items-center text-lg font-medium text-white hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
                  Register Now
                  <svg className="ml-1 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                </a>
              </div>
      ...
      <section className="bg-green-700 dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm mb-8 lg:mb-16">
            ...
            <p className="font-light text-white sm:text-xl dark:text-gray-400">Explore what drivers, restaurants, and customer say about us</p>
          </div> 
          <div id="testimonial-carousel" className="relative" data-carousel="slide">
            <div className="overflow-x-hidden overflow-y-visible relative mx-auto max-w-screen-md h-52 rounded-lg sm:h-48">
              <figure className="hidden mx-auto w-full max-w-screen-md" data-carousel-item>
                <blockquote>
                  <p className="text-lg font-medium text-white sm:text-2xl dark:text-white">"Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</p>
                </blockquote>
                <figcaption className="flex justify-center items-center mt-6 space-x-3">
                  ...
                  <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                    <div className="pr-3 font-medium text-white dark:text-black">Bonnie Green</div>
                    <div className="pl-3 text-sm font-light text-white dark:text-gray-400">Web developer at Google</div>
                  </div>
                </figcaption>
              </figure>
              <figure className="hidden mx-auto w-full max-w-screen-md" data-carousel-item>
                <blockquote>
                  <p className="text-lg font-medium text-white sm:text-2xl dark:text-black">"As someone who mainly designs in the browser, I've been a casual user of Figma, but as soon as I saw and started playing with FlowBite my mind was blown and became so productive."</p>
                </blockquote>
                <figcaption className="flex justify-center items-center mt-6 space-x-3">
                  ...
                  <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                    <div className="pr-3 font-medium text-white dark:text-black">Helene Engels</div>
                    <div className="pl-3 text-sm font-light text-white dark:text-gray-400">Creative designer at Adobe</div>
                  </div>
                </figcaption>
              </figure>
              <figure className="hidden mx-auto w-full max-w-screen-md" data-carousel-item>
                <blockquote>
                  <p className="text-lg font-medium text-white sm:text-2xl text-black">"Flowbite has code in one place and I'm not joking when I say it took me a matter of minutes to copy the code, customise it and integrate within a Laravel + Vue application."</p>
                </blockquote>
                <figcaption className="flex justify-center items-center mt-6 space-x-3">
                  ...
                  <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                    <div className="pr-3 font-medium text-white dark:text-white">Neil Sims</div>
                    <div className="pl-3 text-sm font-light text-white dark:text-gray-400">CTO at Microsoft</div>
                  </div>
                </figcaption>
              </figure>
            </div>
            <div className="flex justify-center items-center">
              <button type="button" className="flex justify-center items-center mr-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev>
                <span className="text-white dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
